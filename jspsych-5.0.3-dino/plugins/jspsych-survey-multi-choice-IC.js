...
jsPsych.plugins['survey-multi-choice-IC'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choice-IC";
    ...
    $trial_form.append($('<input>', {
      ...
      'value': 'Edasta n\xF5usolek' /*Submit Answer*/
    }));
