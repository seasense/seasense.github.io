...
jsPsych.plugins['survey-text-persDemos'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add text box
      $("#jspsych-survey-text-" + i).append('<textarea rows="1" cols="15" style="font-size:20px;" name="#jspsych-survey-text-response-' + i + '" cols="' + trial.columns[i] + '" rows="' + trial.rows[i] + '"></textarea>');
    }
