  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div style=""><p>Katse k\xE4ivitatakse t\xE4isekraanire\u017Eeiimis, kui kl\xF5psate alloleval nupul.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Alusta eksperimenti</button></div>');
